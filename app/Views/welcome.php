...
<nav class="navbar navbar-expand-sm navbar-light bg-light">
    <a href="" class="nanavbar-brand"><img height="44" title="CodeIgniter Logo"
...
<section>
        ...
        <div class="list-group mx-auto text-center w-75">
            <a href="<?= site_url('/managers/1') ?>" target="_blank" class="list-group-item list-group-item-action">
                Manager
            </a>
            <a href="<?= site_url('/evaluators/1') ?>" target="_blank" class="list-group-item list-group-item-action">
                Evaluator
            </a>
...
<footer class="bg-dark justify-content-around navbar navbar-dark position-sticky text-light top-100">
    <div class="copyrights">

        <p>&copy; <?= date('Y') ?> Created by 🏆 Ahmed Selim 🏆</p>
